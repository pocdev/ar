...
public class SB_SwipeDrag : MonoBehaviour {
...
private int activeTouch = -1;
 	...
 	public delegate void SwipeDelegate(SWIPETYPE ST);
	public SwipeDelegate SwipeHandler;
...

        {
...

            {
...

                {
                    ...
                    SwipeComplete(SWIPETYPE.RIGHT,  touch);
...

                {
                        ...
                        SwipeComplete(SWIPETYPE.LEFT,  touch);
